...
export function InstructorPortalLoginForm() {
  ...
  return (
    ...
    >
      ...
      <div className="space-y-2">
        <label
          htmlFor="instructor-portal-password"
          className="text-xs font-semibold uppercase tracking-wide text-dojo-muted"
        >
          Password
        </label>
        <input
          id="instructor-portal-password"
          name="password"
          type="password"
      ...
      <LoginForgotPasswordLink context="instructor" />
