...
import {
  AcademyPixelSettingsForm,
  AcademyPixelSettingsTestingNotes,
} from "@/components/admin/academy-pixel-settings-form";
...
export default async function AcademyPixelSettingsPage({
  ...
  const club = await requireClubBySlug(params.clubSlug);
  const settings = await loadAcademyPixelSettingsForEdit(club.slug);
